...
/**
 * @param {{ entries: import('../hooks/useEntries').Entry[]|undefined, onEdit: Function, onDelete: Function }} props
 */
      ...
      {entries.map(entry => (
        ...
        >
          ...
          <button
            ...
            className="p-1.5 text-gray-400 active:text-indigo-600 shrink-0"
